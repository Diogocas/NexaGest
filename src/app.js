// NexaGest 11.5.5 - Limpeza e Assistente Local
...
const nav=[['dashboard','📊','Dashboard'],['pdv','💵','Caixa'],['products','📦','Produtos'],['stock','🏷️','Estoque'],['clients','👥','Clientes'],['finance','💰','Financeiro'],['purchases','🧾','Compras'],['nfe','📄','Nota Fiscal'],['suppliers','🏢','Fornecedores'],['quotes','📋','Orçamentos'],['deliveries','🚚','Entregas'],['labels','🏷️','Etiquetas'],['reports','📈','Relatórios'],['premium','⭐','Licença'],['cloud','☁️','Cloud'],['ai','🤖','NexaGest AI'],['users','🔒','Usuários'],['settings','⚙️','Configurações']];
